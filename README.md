...
* Do (Drone) SOC Analyst stuff on a live drone on campus and detect/respond to launched attacks in real time 🤠
  ...
  * I promise the compliance/data privacy stuff is done ☹️ Trust me I despised/hated that stuff as much as you did (hopefully we'll never touch that in our lives ever again), now let's do the actual cool blue team stuff
