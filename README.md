...
* Do (Drone) SOC Analyst stuff on a live drone on campus and detect/respond to launched attacks in real time 🤠
  * PLEASE fill out the when2meet (first one) for June you know who you are, I know you're reading this
  * I promise the Identity Access Management/data privacy stuff is done ☹️ Trust me I despised/hated that stuff as much as you did (if "Justin" ever tells you he loves configuring SSO/IAM solutions, shoot him because that's a doppleganger; hopefully we'll never do this stuff again), now let's do the actual cool blue team stuff
